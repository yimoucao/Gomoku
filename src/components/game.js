...
export default class Game extends React.Component {
  gamerRenderOpponentInfo() {
    return (
      <div className="mx-2">
        You are in Game #{this.props.gameId}, with player{" "}
  ...
  watcherRenderOthersInfo(watchInfo) {
    return (
      <div className="mx-2">
        ...
        &nbsp;vs&nbsp;{watchInfo.gamer2}&nbsp;
        {watchInfo.gameInfo ? (
          <span className="badge badge-info">{watchInfo.gameInfo}</span>
        ) : null}
      </div>
    );
  }
    ...
    return (
      <div>
        <div className="d-flex align-items-center mb-2">
          <div>
            <button
              ...
              onClick={() => this.props.leaveClickHandler()}
            >
        ...
        <div className="game row d-flex justify-content-center">
          <div
            className="game-board col-sm-6 d-flex justify-content-end"
            style={{ minWidth: "max-content" }}
          >
            <Board
              placings={this.props.placings}
